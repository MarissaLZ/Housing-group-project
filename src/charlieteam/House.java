...
public class House
{
	...
	public House(String style, double familyRoomSize, double livingRoomSize,
			int numBedrooms, double plotSize)
	{
		this.style = style;
	...
	{
		double area = livingRoomSize + familyRoomSize
				+ (BEDROOM_AREA * (double) numBedrooms);
